...
console.log(head([]));
const object = { 'a': { 'b': 2 } };
console.log(hasIn(object, 'a'));
console.log(hasIn(object, 'b'));
console.log(hasIn(object, 'c'));
...
console.log(hasPath(object, 'a.b'));
console.log(hasPath(object, 'a.c'));
console.log(hasPath(object, ['a','b']));
